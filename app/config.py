...
class Settings(BaseSettings):
    ...
    # KassaAI sub-methods displayed as separate options/buttons
    KASSA_AI_SBP_ENABLED: bool = False
    KASSA_AI_SBP_DISPLAY_NAME: str = 'SBP (KassaAI)'
    KASSA_AI_CARD_ENABLED: bool = False
    KASSA_AI_CARD_DISPLAY_NAME: str = 'Card (KassaAI)'
    KASSA_AI_SBERPAY_ENABLED: bool = False
    ...
    CABINET_ULTIMA_ACCOUNT_LINKING_MODE: str = 'code'
