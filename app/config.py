...
class Settings(BaseSettings):
    ...
    # Сообщение о блокировке за превышение устройств
    # Переменные: {ip_count}, {limit}, {ban_minutes}
    BAN_MSG_PUNISHMENT: str = (
        "🚨 <b>Превышение лимита устройств</b>\n\n"
        "Ваш аккаунт временно заблокирован из-за превышения лимита подключенных устройств.\n\n"
        "📱 Обнаружено устройств: <b>{ip_count}</b>\n"
        "📊 Максимально разрешено: <b>{limit}</b>\n"
        "⏱ Блокировка на: <b>{ban_minutes} мин</b>\n\n"
        "ℹ️ Пожалуйста, отключите лишние устройства и подождите окончания блокировки.\n"
        "После разблокировки ваш доступ будет восстановлен автоматически."
    )
    ...
    BAN_MSG_ENABLED: str = (
        ...
        "Теперь вы снова можете пользоваться VPN. "
        "Пожалуйста, следите за количеством подключенных устройств, "
        "чтобы избежать повторной блокировки."
    )

    # Сообщение о блокировке за WiFi
    # Переменные: {ban_minutes}, {network_type}, {node_name}
    BAN_MSG_WIFI: str = (
        "📶 <b>Блокировка за использование WiFi сети</b>\n\n"
        "Ваш аккаунт временно заблокирован из-за использования WiFi сети.\n\n"
        "{network_info}"
        "{node_info}"
        "⏱ Блокировка на: <b>{ban_minutes} мин</b>\n\n"
        "ℹ️ Использование VPN через WiFi запрещено правилами сервиса.\n"
        "Пожалуйста, используйте мобильную сеть для подключения к VPN.\n\n"
        "После окончания блокировки ваш доступ будет восстановлен автоматически."
    )

    # Сообщение о блокировке за мобильную сеть
    # Переменные: {ban_minutes}, {network_type}, {node_name}
    BAN_MSG_MOBILE: str = (
        "📱 <b>Блокировка за использование мобильной сети</b>\n\n"
        "Ваш аккаунт временно заблокирован из-за использования мобильной сети.\n\n"
        "{network_info}"
        "{node_info}"
        "⏱ Блокировка на: <b>{ban_minutes} мин</b>\n\n"
        "ℹ️ Использование VPN через мобильную сеть запрещено правилами сервиса.\n"
        "Пожалуйста, используйте WiFi для подключения к VPN.\n\n"
        "После окончания блокировки ваш доступ будет восстановлен автоматически."
    )
