...
- 💰 **Многоканальные платежи** - Telegram Stars + MulenPay + Tribute + CryptoBot + ЮKassa + P2P
...
MULENPAY_SECRET_KEY=
MULENPAY_SHOP_ID=
MULENPAY_API_URL=https://mulenpay.ru/api
MULENPAY_WEBSITE_URL=
MULENPAY_LANGUAGE=ru
MULENPAY_VAT_CODE=1
MULENPAY_PAYMENT_SUBJECT=4
MULENPAY_PAYMENT_MODE=1
MULENPAY_MEASUREMENT_UNIT=0
MULENPAY_MIN_AMOUNT_KOPEKS=5000
MULENPAY_MAX_AMOUNT_KOPEKS=1000000
MULENPAY_QUICK_AMOUNT_SELECTION_ENABLED=false
...
3. **💰 Баланс** → "💰 Баланс" → пополни через Stars/MulenPay/Tribute/YooKassa
